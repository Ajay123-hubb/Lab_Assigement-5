...
class StudentManager implements RecordActions {
    ...
    public StudentManager() {
        list.add(new Student(301,"Parth","parth@mail.com","MBA",93.2));
        list.add(new Student(302,"Ayush","ayush@mail.com","B.Tech",85.6));
        list.add(new Student(303,"Lovish","lovish@mail.com","BCA",78.4));
        list.add(new Student(304,"Ajay","ajay@mail.com","MCA",64.7));
    }
